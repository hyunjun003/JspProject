...
<header class="header header-transparent">
    <div class="container-fluid">
        <!-- Brand-->
        <div class="inner-header"><a class="inner-brand" href="main.jpt">Boomerang</a></div>
        <!-- Navigation-->
                        ...
                        <div class="mega-menu">
                            <ul class="sub-menu mega-menu-row" data-background="assets/images/menu-3.jpg">
                                ...
                                <li class="menu-item-has-children mega-menu-col"><a href="#">Multi Page</a>
                                    <ul class="sub-menu">
                                        <li><a href="detail.jpt">Parallax</a></li>
                                        <li><a href="in.jpt">Slider - Fade</a></li>
                                        <li><a href="default.jpt">Slider - Slide</a></li>
...
<div class="wrapper">
    ...
    <section class="module-cover-slides fullscreen">
        <ul class="slides-container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn btn-lg btn-circle btn-warning" href="#">Get Started</a><a class="btn btn-lg btn-circle btn-outline-new-white" href="#">Learn More</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="parallax text-center" data-overlay="0.7" data-gradient="1"><img src="assets/images/module-25.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Your customers will love you <br> one minute from now.</strong></h1>
                            <p class="m-b-40">See how your users experience your website in realtime or view  <br> trends to see any changes in performance over time.</p>
                            <p><a class="btn btn-lg btn-circle btn-new-white" href="#">Get Started</a><a class="btn btn-lg btn-circle btn-outline-new-white" href="#">Learn More</a></p>
                        </div>
                    </div>
                </div>
            </li>
