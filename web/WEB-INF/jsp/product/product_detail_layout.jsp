...
<div class="wrapper">
    ...
    <section class="module">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p><img src="assets/images/portfolio/6.jpg" alt=""></p>
                    <p><img src="assets/images/portfolio/5.jpg" alt=""></p>
                    <p><img src="assets/images/portfolio/4.jpg" alt=""></p>
                    <p><img src="assets/images/portfolio/3.jpg" alt=""></p>
                </div>
                <div class="col-md-4">
                    <div class="sticky-sidebar">
                        <h6 class="single-portfolio-title">Spacé Decor</h6>
                        <p>Just then her head struck against the roof of the hall in fact she was now more than nine feet high and she at once took up the little golden key and hurried off to the garden door.</p>
                        <p>Just then her head struck against the roof of the hall in fact she was now more than nine feet high and she at once took up.</p>
